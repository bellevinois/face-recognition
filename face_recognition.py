...
video= 0 #"./test_img/ana.mp4"
modeldir = r'./model/20180402-114759.pb'
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        minsize = 30  # минимальный размер лица
        ...
        print('Начать распознования')
        while True:
            ret, frame = video_capture.read()
            frame = cv2.resize(frame, (0,0), fx=0.5, fy=0.5)    #изменить размер рамки (необязательно)
            timer = time.time()
            if frame.ndim == 2:
                        ...
                        if best_class_probabilities>0.87:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    print("Прогноз : [ имя: {} , точность: {:.3f} ]".format(HumanNames[best_class_indices[0]],best_class_probabilities[0]))
